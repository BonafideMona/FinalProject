...
function CategoryBox({ title }) {
  ...
  return (
    <div className="w-56 flex flex-col items-center justify-between h-full p-4 rounded-2xl border border-[#d6c9b4] bg-[#fefaf4] shadow-md hover:shadow-lg transition">
